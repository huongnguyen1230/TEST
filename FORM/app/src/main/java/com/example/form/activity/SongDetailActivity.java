...
import com.example.form.service.impl.LyricDotComService;
import com.example.form.util.MyGlobalClass;
...
public class SongDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        Glide.with(this).load(currentSong.getThumbnail()).into(thumbnailImageView);
        try {
    ...
    private void initActions() {
        ...
        controlImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d("Play CONSTANT CONTEXT: ",  String.valueOf(ContextCompat.getDrawable(SongDetailActivity.this, R.drawable.ic_baseline_play_circle_filled_24).getConstantState()));
    ...
    private void showBottomSheetDialog() {
        ...
        try {
            LyricsService lyricService = new LyricDotComService();
